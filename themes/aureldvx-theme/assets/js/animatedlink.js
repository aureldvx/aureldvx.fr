...
var LinkFx = /*#__PURE__*/function () {
  function LinkFx(el) {
    ...
    this.DOM.text.classList = 'animated__link-inner';
    ...
    this.DOM.line.classList = 'animated__link-deco';
...
var LinkFx1 = /*#__PURE__*/function (_LinkFx) {
  ...
  var _super = _createSuper(LinkFx1);
...
if(mobileAndTabletCheck() === false) {
  _toConsumableArray(document.querySelectorAll('a.animated__link')).forEach(function (el) {
    var fxObj = _animatedLink.default[0];
    fxObj && new fxObj(el);
  });
}
