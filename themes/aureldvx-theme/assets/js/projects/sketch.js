...
class Sketch {
  constructor(opts) {
    ...
    this.clickerPrev = document.querySelector(opts.clickerPrev);
    this.clickerNext = document.querySelector(opts.clickerNext);
  ...
  clickEvent(){
    this.clickerPrev.addEventListener('click',()=>{
      this.prev();
    })
    this.clickerNext.addEventListener('click',()=>{
      this.next();
    })
  }
  settings() {
  ...
  prev(){
    ...
    let prevTexture;
    this.current === 0
    ? prevTexture =this.textures[(len - 1)]
      : prevTexture =this.textures[(this.current - 1)];
