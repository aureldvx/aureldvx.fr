...
function resize() {
  let ambientContainer = document.querySelector('.playground');
  let innerWidth = ambientContainer.clientWidth;
  let innerHeight = ambientContainer.clientHeight;
