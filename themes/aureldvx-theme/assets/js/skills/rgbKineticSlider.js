(function() {
    ...
    window.rgbKineticSlider = function(options) {
        ...
        options.googleFonts = options.hasOwnProperty('googleFonts') ? options.googleFonts : ['Playfair Display:500'];
        ...
        function cursorInteractive() {
            ...
            let sliderContainer = document.querySelector('section.title');
            sliderContainer.addEventListener("mousemove", onPointerMove);
